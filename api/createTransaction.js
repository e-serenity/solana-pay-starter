...
const usdcAddress = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
const sellerAddress = "EnAgw24ycRekUCbbE4yH815QdSytNVZVCrxXrm1mahBC";
...
const createTransaction = async (req, res)=>{
    try {
        ...
        const itemPrice = _products_json__WEBPACK_IMPORTED_MODULE_4__.find((item)=>item.id === itemID
        ).price;
        if (!itemPrice) {
            res.status(404).json({
        ...
        const network = _solana_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletAdapterNetwork.Mainnet;
